...
class IniciarCuentaRegresivaUseCaseTest {
    ...
    private Flux<DomainEvent> historico2() {
        ...
        var event2 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("heyler"), 1000, true, true,"www"),
        ...
        //JUGADOR 1//
        var event7 = new CartaPuestaEnTablero(event4.getTableroId(), event2.getJugadorId(), new Carta(CartaMaestraId.of("heyler"), 1000, true, true, "www"));
        event7.setAggregateRootId("XXXX");

        var event8 = new CartaQuitadaDelMazo(event2.getJugadorId(), new Carta(CartaMaestraId.of("heyler"), 1000, true, true, "www"));
